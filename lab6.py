...
class Player(pygame.sprite.Sprite):
    def __init__(self):
        ...
        self.surf = pygame.image.load("images/aviao.png").convert_alpha()
...
class Enemy(pygame.sprite.Sprite):
    def __init__(self):
        ...
        self.surf = pygame.image.load("images/missel.png").convert_alpha()
        self.rect = self.surf.get_rect(
            center=(
...
# texto
fonte1 = pygame.font.SysFont('Arial Black', 10)
textoSom = fonte1.render ("Música ON/OFF = F10", True, (255, 255, 255), (0, 0, 0))
pos_textoSom = textoSom.get_rect()
pos_textoSom.center = (700,10)

# musica
pygame.mixer.music.load("sounds/alexander-nakarada-chase.mp3")
...
while jogoAtivo:
    ...
    screen.blit(textoSom, pos_textoSom)
